...
int8_t V2avehiclefltsta537::VCUSysMotorOverTempSta() {
  Byte t0(*(bytes + 0));
...
int8_t V2avehiclefltsta537::VCUSysBmsOverTempSta() {
  Byte t0(*(bytes + 0));
...
int8_t V2avehiclefltsta537::VCUSysBrakeOverTempSta() {
  Byte t0(*(bytes + 0));
...
int8_t V2avehiclefltsta537::VCUSysSteerOverTempSta() {
  Byte t0(*(bytes + 0));
...
int8_t V2avehiclefltsta537::VCUSysUnderVolt() {
  Byte t0(*(bytes + 0));
...
int8_t V2avehiclefltsta537::VCUSysFlt() {
  Byte t0(*(bytes + 1));
...
int8_t V2avehiclefltsta537::VCUSysBrakeFlt() {
  Byte t0(*(bytes + 1));
...
int8_t V2avehiclefltsta537::VCUSysParkingFlt() {
  Byte t0(*(bytes + 2));
  int32_t x = t0.get_byte(0, 4);
...
int8_t V2avehiclefltsta537::VCUSysSteerFrontFlt() {
  Byte t0(*(bytes + 2));
  int32_t x = t0.get_byte(4, 4);
...
int8_t V2avehiclefltsta537::VCUSysSteerBackFlt() {
  Byte t0(*(bytes + 3));
  int32_t x = t0.get_byte(0, 4);
...
int8_t V2avehiclefltsta537::VCUSysMotorLfFlt() {
  Byte t0(*(bytes + 3));
  int32_t x = t0.get_byte(4, 4);
...
int8_t V2avehiclefltsta537::VCUSysMotorRfFlt() {
  Byte t0(*(bytes + 4));
  int32_t x = t0.get_byte(0, 4);
...
int8_t V2avehiclefltsta537::VCUSysMotorLrFlt() {
  Byte t0(*(bytes + 4));
  int32_t x = t0.get_byte(4, 4);
...
int8_t V2avehiclefltsta537::VCUSysMotorRrFlt() {
  Byte t0(*(bytes + 5));
  int32_t x = t0.get_byte(0, 4);
...
int8_t V2avehiclefltsta537::VCUSysBmsFlt() {
  Byte t0(*(bytes + 5));
  int32_t x = t0.get_byte(4, 4);
...
int8_t V2avehiclefltsta537::VCUSysDcFlt() {
  Byte t0(*(bytes + 6));
  int32_t x = t0.get_byte(0, 4);
