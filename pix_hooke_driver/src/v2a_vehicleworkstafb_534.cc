...
int8_t V2avehicleworkstafb534::VCUDrivingModeFb() {
  Byte t0(*(bytes + 0));
...
int8_t V2avehicleworkstafb534::VCUChassisPowerStaFb() {
  Byte t0(*(bytes + 0));
...
int8_t V2avehicleworkstafb534::VCUChassisPowerDcSta() {
  Byte t0(*(bytes + 0));
...
int8_t V2avehicleworkstafb534::VCUChassisSpeedLimitedModeFb() {
  Byte t0(*(bytes + 1));
...
int8_t V2avehicleworkstafb534::VCUChassisPowerLimiteSta() {
  Byte t0(*(bytes + 1));
...
int8_t V2avehicleworkstafb534::VCUSysEcoMode() {
  Byte t0(*(bytes + 1));
  int32_t x = t0.get_byte(2, 2);
...
int8_t V2avehicleworkstafb534::VCUChassisEStopStaFb() {
  Byte t0(*(bytes + 5));
...
int8_t V2avehicleworkstafb534::VCUCrashFrontSta() {
  Byte t0(*(bytes + 5));
...
int8_t V2avehicleworkstafb534::VCUCrashRearSta() {
  Byte t0(*(bytes + 5));
...
int8_t V2avehicleworkstafb534::VCUCrashLeftSta() {
  Byte t0(*(bytes + 5));
...
int8_t V2avehicleworkstafb534::VCUCrashRightSta() {
  Byte t0(*(bytes + 5));
...
int32_t V2avehicleworkstafb534::VCULife() {
  Byte t0(*(bytes + 6));
  int32_t x = t0.get_byte(0, 4);
...
int32_t V2avehicleworkstafb534::VCUCheckSum() {
  Byte t0(*(bytes + 7));
  int32_t x = t0.get_byte(0, 8);
