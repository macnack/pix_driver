...
int8_t V2abrakestafb531::VCUChassisBrakeEnSta() {
  Byte t0(*(bytes + 0));
...
int8_t V2abrakestafb531::VCUVehicleBrakeLampFb() {
  Byte t0(*(bytes + 0));
...
int8_t V2abrakestafb531::VCUChassisEpbFb() {
  Byte t0(*(bytes + 0));
...
int8_t V2abrakestafb531::VCUAebEnStaFb() {
  Byte t0(*(bytes + 3));
  int32_t x = t0.get_byte(0, 1);
...
int8_t V2abrakestafb531::VCUAebTriggerStaFb() {
  Byte t0(*(bytes + 3));
  int32_t x = t0.get_byte(2, 1);
