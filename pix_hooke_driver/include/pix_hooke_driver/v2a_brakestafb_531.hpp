...
public:
    ...
    // singal
    int8_t vcu_chassisbrakeensta;
    int8_t vcu_vehiclebrakelampfb;
    int8_t vcu_chassisepbfb;
    double vcu_chassisbrakepadlfb;
    int8_t vcu_aebenstafb;
    int8_t vcu_aebtriggerstafb;
