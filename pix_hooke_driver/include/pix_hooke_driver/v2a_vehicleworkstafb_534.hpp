...
public:
    ...
    // singal
    int8_t vcu_drivingmodefb;
    int8_t vcu_chassispowerstafb;
    int8_t vcu_chassispowerdcsta;
    int8_t vcu_chassisspeedlimitedmodefb;
    int8_t vcu_chassispowerlimitesta;
    int8_t vcu_sysecomode;
    double vcu_chassisspeedlimitedvalfb;
    double vcu_chassislowpowervoltsta;
    int8_t vcu_chassisestopstafb;
    int8_t vcu_crashfrontsta;
    int8_t vcu_crashrearsta;
    int8_t vcu_crashleftsta;
    int8_t vcu_crashrightsta;
    int32_t vcu_life;
    int32_t vcu_checksum;
...
private:
  ...
  int8_t VCUChassisSpeedLimitedModeFb();
  ...
  int8_t VCUChassisPowerLimiteSta();
