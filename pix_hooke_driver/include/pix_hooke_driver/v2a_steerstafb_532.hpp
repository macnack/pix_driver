...
public:
    static constexpr uint32_t ID = 0x532;
    V2asteerstafb532();
    void Parse();
    void update_bytes(uint8_t bytes_data[8]);
    // singal
    int8_t vcu_chassissteerensta;
    int8_t vcu_chassissteerslopover;
    int8_t vcu_chassissteerworkmode;
    int8_t vcu_chassissteermodefb;
    int32_t vcu_chassissteeranglefb;
    int32_t vcu_chassissteeranglerearfb;
...
private:
  ...
  int8_t VCUChassisSteerSlopover();
  ...
  int8_t VCUChassisSteerWorkMode();
  ...
  int32_t VCUChassisSteerAngleFb();
  ...
  int32_t VCUChassisSteerAngleRearFb();
