...
public:
    static constexpr uint32_t ID = 0x537;
    V2avehiclefltsta537();
    void Parse();
    void update_bytes(uint8_t bytes_data[8]);
    // singal
    int8_t vcu_sysmotorovertempsta;
    int8_t vcu_sysbmsovertempsta;
    int8_t vcu_sysbrakeovertempsta;
    int8_t vcu_syssteerovertempsta;
    int8_t vcu_sysundervolt;
    int8_t vcu_sysflt;
    int8_t vcu_sysbrakeflt;
    int8_t vcu_sysparkingflt;
    int8_t vcu_syssteerfrontflt;
    int8_t vcu_syssteerbackflt;
    int8_t vcu_sysmotorlfflt;
    int8_t vcu_sysmotorrfflt;
    int8_t vcu_sysmotorlrflt;
    int8_t vcu_sysmotorrrflt;
    int8_t vcu_sysbmsflt;
    int8_t vcu_sysdcflt;
