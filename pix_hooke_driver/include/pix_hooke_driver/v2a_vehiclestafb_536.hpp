...
public:
    static constexpr uint32_t ID = 0x536;
    V2avehiclestafb536();
    void Parse();
    void update_bytes(uint8_t bytes_data[8]);
    // singal
    int8_t vcu_vehicleposlampfb;
    int8_t vcu_vehicleheadlampfb;
    int8_t vcu_vehicleleftlampfb;
    int8_t vcu_vehiclerightlampfb;
    int8_t vcu_vehiclehighbeamfb;
    int8_t vcu_vehiclefoglampfb;
    int8_t vcu_vehiclehazardwarlampfb;
    int8_t vcu_vehiclebodylampfb;
    int8_t vcu_vehiclereadlampfb;
    int8_t acu_vehiclewindowfb;
    int8_t vcu_vehicledoorstafb;
    int8_t vcu_vehiclewipersstafb;
    int8_t vcu_vehiclesafetybelt1;
    int8_t vcu_vehiclesafetybelt2;
    int8_t vcu_vehiclesafetybelt3;
    int8_t vcu_vehiclesafetybelt4;
...
private:
  ...
  int8_t VCUVehicleHazardWarLampFb();
