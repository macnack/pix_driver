...
public:
    static constexpr uint32_t ID = 0x539;
    V2achassiswheelrpmfb539();
    void Parse();
    void update_bytes(uint8_t bytes_data[8]);
    // singal
    int32_t vcu_chassiswheelrpmlf;
    int32_t vcu_chassiswheelrpmrf;
    int32_t vcu_chassiswheelrpmlr;
    int32_t vcu_chassiswheelrpmrr;
